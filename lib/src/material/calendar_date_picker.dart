    ...
    switch (_mode) {
      case DatePickerMode.day:
        return _MonthPicker(
          ...
          dayWeekStyle: widget.dayWeekStyle,
        );
    ...
    return (NepaliUtils().language == Language.english
        ...
        .map<Widget>(
          (label) => ExcludeSemantics(
            child: Center(
              child: Text(label, style: widget.dayWeekStyle),
            ),
          ),
        )
        .toList();
